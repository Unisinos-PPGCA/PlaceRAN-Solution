...
def plot_dsg_number():
    ...
    y[4] = [0, 10, 23, 0, 0, 10, 31] # DSG 2 - 2
    y[7] = [0, 0, 0, 0, 0, 0, 0] # DSG 4 - 7
    y[6] = [0, 2, 1, 0, 0, 6, 2] # DSG 5 - 8
    y[9] = [0, 0, 0, 0, 0, 0, 0] # DSG 6 - 12
    y[8] = [27, 23, 10, 0, 29, 25, 13] # DSG 7 - 13
    y[10] = [12, 3, 0, 0, 20, 2, 0] # DSG 8 - DRAN
    y[1] = [0, 1, 5, 0, 0, 6, 3] # DSG 9 - 18 - CRAN
    y[2] = [0, 0, 0, 0, 0, 0, 0] # DSG 10 - 17 - CRAN
